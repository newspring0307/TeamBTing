			   ...
			   <div class="navbar-header">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            <li><a href="index" style="color:#1C1185"><span>팅이란?</span></a></li>
		            <li><a href="Main_company_1_team" style="color:#1C1185"><span>Team</span></a></li>
		            <li><a href="Tingtoday_0_main" style="color:#1C1185"><span>팅투하자!</span></a></li>
		            <li><a href="Premium_0_main" style="color:#1C1185"><span>프리미엄</span></a></li>
		            <li><a href="Fun_0_main" style="color:#1C1185"><span>FUN</span></a></li>
		            <li><a href="Client_2_Ting_main" style="color:#1C1185"><span>문의</span></a></li>
...
인증번호 입력해주세요</h3>
		    ...
		    <a class="ui fluid large teal submit button" href="#" onclick="location.href='Main_login_1_PW_reset'">인증</a>
	        </div>
			</div>
